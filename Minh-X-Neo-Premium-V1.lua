...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://17689642993"
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=17689642993"
...
function Update:Window(text,logo,keybind)
    ...
    ServerTime.BackgroundColor3 = Color3.fromRGB(0,255,255)
    ...
    Ping.Name = "Ping"
    Ping.Parent = Top
    Ping.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    Ping.BackgroundTransparency = 1.000
    Ping.Position = UDim2.new(0.28, 0,0.074, 0)
    Ping.Size = UDim2.new(0, 225, 0, 25)
    Ping.Font = Enum.Font.GothamSemibold
    Ping.Text = "Minh-X-Neo-Premium-vip"
    Ping.TextColor3 = Color3.fromRGB(192,192,192)
	...
	Logo.Image = "rbxassetid://17689642993"
...
Page.Image = ""
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://17689642993"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://17689642993"
        ...
        ImageButton.ImageColor3 = Color3.fromRGB(0, 255, 255)
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropTitle.Text = text.. " : "
        DropTitle.TextColor3 = Color3.fromRGB(0,255,255)
        ...
        for i,v in next,option do
            ...
            Item.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        SliderInput.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
        ...
        Title_2.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
local Library = Update:Window("Minh X Neo Premium","",Enum.KeyCode.RightControl);

--local NguyenTien = Library:AddTab("Information","4483345998")
local Main = Library:AddTab("Main","17689642993")
local M = Library:AddTab("Item","9606626859")
local Ss = Library:AddTab("Stats","14764174048")
local K = Library:AddTab("Event","15679744806")
local RaceV4 = Library:AddTab("Race V4","11446900930")
local P = Library:AddTab("PVP","14764193934")
local R = Library:AddTab("Dungeon","14764250087")
local T = Library:AddTab("Teleport","14764218351")
local S = Library:AddTab("Shop","14764233722")
local D = Library:AddTab("Devil Fruit","14764242920")
local Misc = Library:AddTab("Misc","11447063791")
...
elseif _G.WhiteScreen == false then
    ...
    Main:AddSlider("Kill At %",1,100,35,function(value)
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=17689642993",
							Duration = 2.5
						})
					end
...
M:AddLabel("NOT WORKING under Development")

local function GetMaterial(name, amount)
...
M:AddToggle("Taken Cursed Dual Katana",TestCDK,function(value)
TestCDK = value
StopTween(Auto_Cursed_Dual_Katana)
    if TestCDK == false then
    ...
    elseif GetMaterial("Alucard Fragment", 2) then
        Checker_Yama_1 = false
        Checker_Yama_2 = false
    end
end)
...
spawn(function()
		while wait() do
			pcall(function()
				if Auto_Cursed_Dual_Katana then
                    if not GetMaterial("Alucard Fragment", 1) then
    ...
    spawn(function()
        while wait() do
            pcall(function()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if Auto_Quest_Yama_2 and v:FindFirstChild("HazeESP") and (v.HumanoidRootPart.Position - PosMonHaze.Position).magnitude <= 300 then
                        v.HumanoidRootPart.CFrame = PosMonHaze
                        v.HumanoidRootPart.CanCollide = false
                        print("work haze haze")
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
						...
						if v:FindFirstChild("HazeESP") then
							repeat wait()
								if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 2000 then
									HyperCahaya(v.HumanoidRootPart.CFrameMon * CFrame.new(0,20,0))
								else
									StartMagnet = true
									FastAttack = true
									if Auto_Buso then
									...
									if not game.Players.LocalPlayer.Character:FindFirstChild(_G.SelectCDK) then
										wait()
										EquipWeapon(_G.SelectCDK)
									end
									PosMonHaze = v.HumanoidRootPart.CFrame
							...
							for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
								if y:FindFirstChild("HazeESP") then
									if (y.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 999999 then
    ...
    spawn(function()
        while wait(5) do
            if Checker_Yama_1 then
                pcall(function() 
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("HazeESP") then
                            repeat wait()
                                if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 1250 then
                                    HyperCahaya(v.HumanoidRootPart.CFrame * Pos)
                                else
                                    EquipWeapon(_G.SelectCDK)
                                    PosMonHaze = v.HumanoidRootPart.CFrame
                                    TP1(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                            ...
                            for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                if y:FindFirstChild("HazeESP") then
                                    ...
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-290.074677, 42.9034653, 5581.58984, 0.965929627, -0, -0.258804798, 0, 1, -0, 0.258804798, 0, 0.965929627)
                                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                                    Checker_Yama_7 = false
                                    Checker_Yama_2 = true
								end
							end
                        end
                        ...
                        if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("HazeESP") then
                            ...
                            for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                if y:FindFirstChild("HazeESP") then
                                    ...
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(5833.1147460938, 51.60498046875, -1103.0693359375)
                                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                                    Checker_Yama_1 = false
                                    Checker_Yama_3 = true
								end
                        ...
                        if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("HazeESP") then
                            ...
                            for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                if y:FindFirstChild("HazeESP") then
                                    ...
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2180.54126, 27.8156815, -6741.5498, -0.965929747, 0, 0.258804798, 0, 1, 0, -0.258804798, 0, -0.965929747)
                                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                                    Checker_Yama_2 = false
                                    Checker_Yama_4 = true
								end
                        ...
                        if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("HazeESP") then
                            ...
                            for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                if y:FindFirstChild("HazeESP") then
                                    ...
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-10581.6563, 330.872955, -8761.18652, -0.882952213, 0, 0.469463557, 0, 1, 0, -0.469463557, 0, -0.882952213)
                                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                                    Checker_Yama_3 = false
                                    Checker_Yama_5 = true
								end
							end
                        end
                        ...
                        if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("HazeESP") then
                            ...
                            for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                if y:FindFirstChild("HazeESP") then
                                    ...
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-10407.5263671875, 331.76263427734375, -8368.5166015625)
                                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                                    Checker_Yama_4 = false
                                    Checker_Yama_6 = true
								end
							end
                        end
                        ...
                        if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("HazeESP") then
                            ...
                            for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                if y:FindFirstChild("HazeESP") then
                                    ...
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-13274.478515625, 332.3781433105469, -7769.58056640625)
                                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                                    Checker_Yama_5 = false
                                    Checker_Yama_7 = true
								end
							end
                        end
            ...
            if _G.Checker_Yama_2 then
                pcall(function()
                   ...
                   --wait(10)
                    ...
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                    --wait(10)
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-9479.2168, 141.215088, 5566.09277, 0, 0, 1, 0, 1, -0, -1, 0, 0)
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2104.3908691406, 38.104167938232, -10194.21875, 0, 0, -1, 0, 1, 0, 1, 0, 0)
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-820.64825439453, 65.819526672363, -10965.795898438, 0, 0, -1, 0, 1, 0, 1, 0, 0)
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-872.24658203125, 65.81957244873047, -10919.95703125)
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2374.13671875, 37.79826354980469, -12125.30859375)
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1887.8099365234375, 77.6185073852539, -12998.3505859375)
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2216.188232421875, 82.884521484375, -12869.2939453125)                            
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(582.590576171875, 77.18809509277344, -12463.162109375)
                    game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health = 0
                end)
            end
        end
            ...
            pcall(function()
                if _G.BringMonster then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        if _G.Auto_Bone and StartMagnetCDK then
                            if (v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy") and (v.HumanoidRootPart.Position - PosMonCDKYama.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
                                v.HumanoidRootPart.CFrame = PosMonCDKYama
                                if v.Humanoid:FindFirstChild("Animator") then
                                    v.Humanoid.Animator:Destroy()
                                end
                                sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
...
local FM = K:AddLabel("Be In Third Sea")
...
local Kitstatus = K:AddLabel(">> Kitsune Island Status <<")

spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
                Kitstatus:Set("[ Kitsune Island Status ]  ✅")
...
K:AddSeperator(">> Kitsune Island <<")

K:AddToggle("Summon Kitsune Island [ Full Moon ]",false,function(vu)
    _G.SummonKitsune = vu
    StopTween(_G.SummonKitsune)
end)

spawn(function()
    while wait() do
        if _G.SummonKitsune then
            pcall(function()
                if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                    HyperCahaya(CFrame.new(-43186.0938, 20.755722, 14150.7451, 0.404593438, -0.026889408, 0.914101243, 0.0663140193, 0.9977988, 5.95448357e-10, -0.912089169, 0.06061773, 0.405485988))
                end
            end)
        end
    end
...
K:AddToggle("Teleport To Kitsune Island",false,function(vu)
    _G.Kitsune = vu
...
spawn(function()
    while wait() do
        if _G.Kitsune then
            pcall(function()
                if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
                    _G.SummonKitsune = false
                    HyperCahaya(game:GetService("Workspace").Map:WaitForChild("KitsuneIsland").ShrineActive:FindFirstChild("NeonShrinePart").CFrame)
                end
            end)
        end
    end
...
K:AddToggle("Kitsune Island Hop",false,function(vu)
    _G.KitsuneHop = vu
end)
...
K:AddToggle("Auto Collect Azure Ember",false,function(vu)
    _G.AzureKitsune = vu
    if _G.AzureKitsune == true then
        ...
        if _G.AzureKitsune then
            pcall(function()
                if game:GetService("Workspace"):FindFirstChild("AttachedAzureEmber") then
                    HyperCahaya(game:GetService("Workspace"):WaitForChild("EmberTemplate"):FindFirstChild("Part").CFrame)
                    _G.SummonKitsune = false
                    _G.Kitsune = false
                end
            end)
...
K:AddToggle("Auto Trade Azure Ember",_G.TradeItem,function(state)
...
if state and findItem("Azure Ember", 20) then
        print("True")
        _G.TradeItem = true
elseif state and (not findItem("Azure Ember", 20)) then
        print("False")
        _G.TradeItem = false
        game.StarterGui:SetCore("SendNotification", {
            Icon = "rbxassetid://17689642993",
            Title = "! WARNING !", 
            Text = "You need more materials \nto Trade Azure Ember."
        })
    else
        _G.TradeItem = false
    end

if _G.TradeItem then
    game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RF/KitsuneStatuePray"):InvokeServer()
    print("Trade Succeed")
    end
end)

K:AddSeperator("Frozen Dimension")

FrozenIsland = K:AddLabel("")
...
K:AddToggle('Frozen Dimension [ NEED SPAWN ]', false, function(value)
...
K:AddSeperator("Sea Beast Event (Not Work)")
 
K:AddToggle('Auto Sea Beast', false, function(value)
...
K:AddSeperator("Pirate Event")

K:AddToggle('Auto PirateBrigade', _G.bjirPirateBrigade, function(value)
    _G.bjirPirateBrigade = value
    StopTween(_G.bjirPirateBrigade) 
end)

function CheckPirate()
    local checkmmpb = {"PirateBrigade", "PirateGrandBrigade"}
        ...
        pcall(function()
            if _G.bjirPirateBrigade then
                if CheckPirate() then
                    ...
                    until not v or not v.Parent or v.Health.Value <= 0 or not CheckPirate()
                    getgenv().psskill = nil
...
K:AddToggle('Auto GhostShip', _G.bjirFishBoat, function(value)
...
K:AddSeperator("Sea Event")
    
K:AddToggle("Auto Terrorshark",_G.Makori_gay,function(value)
                ...
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") then
                            ...
                            if v.Name == "Terrorshark" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        MakoriGayMag = false
                                        PosGay = v.HumanoidRootPart.CFrame
                                        HyperCahaya(v.HumanoidRootPart.CFrame * CFrame.new(2,58,2))
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark") then
                            HyperCahaya(game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark").HumanoidRootPart.CFrame * CFrame.new(2,55,2))
                        else
                            if _G.StardHop then
                                Hop()
                            end
...
K:AddToggle("Auto Shark",_G.Makori_gay,function(value)
_G.bjirShark = value
                            ...
                            if v.Name == "Shark" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        MakoriGayMag = false
                                        PosGay = v.HumanoidRootPart.CFrame
                                        HyperCahaya(v.HumanoidRootPart.CFrame * CFrame.new(2,49,2))
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
...
K:AddToggle("Auto Piranha",_G.Makori_gay,function(value)
...
--[[
K:AddToggle('Auto Get Anchor [ Need Material ]', _G.BjirAnchorCuy, function(state)
local function findItem(name, amount)
    for _, item in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventory")) do
        if item["Type"] == "Material" and item["Name"] == name and item["Count"] >= amount then
            return true
...
K:AddToggle("Auto Sail To Rough Sea",_G.AutoRemover,function(state)
if state then
    _G.AutoRemover = true
else
        ...
        pcall(function()
            if _G.BiirTrax then
                ...
                local enemyTypes = {
                    ...
                    {name = "Piranha", variable = "bjirPiranha"},
                    {name = "FishBoat", variable = "bjirFishBoat"},
                    {name = "PirateBrigade", variable = "bjirPirateBrigade"},
                    {name = "PirateGrandBrigade", variable = "bjirPirateBrigade"},
                }
                    ...
                    if v.Name:find("VehicleSeat") then
                        ...
                        for _, enemyType in pairs(enemyTypes) do
                            ...
                            if game:GetService("Workspace").Enemies:FindFirstChild(enemyName) then
                                ...
                                game:GetService("VirtualInputManager"):SendKeyEvent(true,"V",false,game)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Boats.Guardian:FindFirstChild("CustomDecal").CFrame
                                wait(0.2)
                                if game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit == false then
                                HyperCahaya(game:GetService("Workspace").Boats.Guardian.VehicleSeat.CFrame * CFrame.new(0,1,0))
                                wait(0.1)
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = vehicleSeat.CFrame
        ...
        if _G.BiirTrax then
            pcall(function()
                if game:GetService("Players").LocalPlayer.Character.Humanoid.Health <= 0 then
                    game:GetService("StarterGui"):SetCore("SendNotification", {
                        Title = "Safe Event"; 
                        Text = "You are Dying from Sea Event"; 
                        Icon = "http://www.roblox.com/asset/?id=17689642993";
                        Duration = 10;
                        Button1 = "Okay"
                    })
                    _G.AutoRemover = false
                    _G.BiirTrax = false
                    _G.bjirPiranha = false
                    _G.bjirShark = false
                    _G.bjirTerrorshark = false
                    _G.bjirFishBoat = false
                    _G.bjirPirateBrigade = false
                    local Remover332 = game.Workspace.Boats:FindFirstChild("Guardian") if Remover332 then Remover332:Destroy() end
                    game:GetService("StarterGui"):SetCore("SendNotification", {
                        Title = "Safe Event"; 
                        Text = "Currently Turning off Sea Event Feature"; 
                        Icon = "http://www.roblox.com/asset/?id=17689642993";
                        Duration = 15;
                        Button1 = "Okay"
                    })
                    game:GetService("StarterGui"):SetCore("SendNotification", {
                        Title = "Safe Event"; 
                        Text = "Please Reactive Sea Event"; 
                        Icon = "http://www.roblox.com/asset/?id=17689642993";
                        Duration = 15;
                        Button1 = "Okay"
                    })
...
S:AddDropdown("Abilities",AbiList,function(vu)
    _G.Abilities = vu
end)

if _G.Abilities == nil then
    _G.Abilities = ""
end

S:AddButton("Buy Abilities",function()
    if _G.Abilities == "Geppo [ $10,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    elseif _G.Abilities == "Buso Haki [ $25,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    elseif _G.Abilities == "Soru [ $25,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    elseif _G.Abilities == "Observation Haki [ $750,000 Beli ]" then
...
FightingStyle = {
    ...
    "Dragon Claw | $1,500 Fragment",
    "Super Human | $3,000,000 Beli",
    "Death Step | $5,000 Frag | $5,000,000 Beli",
    "Sharkman Karate | $5,000 Frag | $2,500,000 Beli",
    "Electric Claw | $5,000 Frag | $3,000,000 Beli",
    "Dragon Talon | $5,000 Frag | $3,000,000 Beli",
    "God Human | $5,000 Frag | $5,000,000 Beli"
}

S:AddSeperator("Fighting Style")

S:AddDropdown("Melee",FightingStyle,function(vu)
    _G.BuyMelee = vu
end)

if _G.BuyMelee == nil then
    _G.BuyMelee = ""
end

S:AddButton("Buy Fighting Style",function()
    if _G.BuyMelee == "Black Leg | $150,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    elseif _G.BuyMelee == "Electro | $550,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
    elseif _G.BuyMelee == "Fishman Karate | $750,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    elseif _G.BuyMelee == "Dragon Claw | $1,500 Fragment" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    elseif _G.BuyMelee == "Super Human | 3,000,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    elseif _G.BuyMelee == "Death Step | $5,000 Frag | $5,000,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    elseif _G.BuyMelee == "Sharkman Karate | $5,000 Frag | $2,500,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    elseif _G.BuyMelee == "Electric Claw | $5,000 Frag | $3,000,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    elseif _G.BuyMelee == "Dragon Talon | $5,000 Frag | $3,000,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    elseif _G.BuyMelee == "God Human | $5,000 Frag | $5,000,000 Beli" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end
end)
...
S:AddDropdown("Sword",SwordStyle,function(vu)
    _G.SwordStyle = vu
end)

S:AddButton("Buy Sword",function()
    if _G.SwordStyle == "Cutlass [ $1,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
    elseif _G.SwordStyle == "Katana [ $1,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
    elseif _G.SwordStyle == "Iron Mace [ $25,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
    elseif _G.SwordStyle == "Dual Katana [ $12,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
    elseif _G.SwordStyle == "Triple Katana [ $60,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
    elseif _G.SwordStyle == "Pipe [ $100,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
    elseif _G.SwordStyle == "Dual-Headed Blade [ $400,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
    elseif _G.SwordStyle == "Bisento [ $1,200,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
    elseif _G.SwordStyle == "Soul Cane [ $750,000 Beli ]" then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
    elseif _G.SwordStyle == "Pole v.2 [ 5,000 Fragments ]" then
        game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ThunderGodTalk")
    elseif _G.SwordStyle == "Yama Sword [ Elite Hunter 30 ]" then
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress") >= 30 then
            repeat wait(.1)
                fireclickdetector(game:GetService("Workspace").Map.Waterfall.SealedKatana.Handle.ClickDetector)
            until game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Yama")
        end
    end
end)
...
Misc:AddToggle("Graphic",false,function(v)
			if v then
				...
				a.ColorShift_Top = Color3.fromRGB(0, 255, 255)
				...
				if getgenv().mode == "Summer" then
					c.TintColor = Color3.fromRGB(0 255, 255)
				...
				e.Saturation = 0
				e.Enabled = true
				e.TintColor = Color3.fromRGB(0 255, 255)
				...
				e2.Saturation = -0.1
				e2.Enabled = true
				e2.TintColor = Color3.fromRGB(0 255, 255)
