...
local serv = win:Server("Minh x Neo V0.5","")
    ...
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
                checkkitsune:Refresh('🦊: Kitsune xuất hiện')
            else
                checkkitsune:Refresh('🔴: Kitsune đéo xuất hiện')
            end
        end
    end)
end)
